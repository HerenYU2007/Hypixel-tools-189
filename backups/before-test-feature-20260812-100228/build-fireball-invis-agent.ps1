...
$outputJar = Join-Path $outputDir 'fireball-invis-standalone-agent-1.8.9.jar'
...
Get-ChildItem -Path (Join-Path $root 'source\fireball_invis\java') -Recurse -Filter '*.java' |
