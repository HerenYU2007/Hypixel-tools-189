...
$outputJar = Join-Path $outputDir 'fireball-invis-standalone-agent-1.8.9-invis2.jar'
...
Get-ChildItem -Path (Join-Path $root 'src\fireball_invis\java') -Recurse -Filter '*.java' |
